...
verilator -Wall --trace --timing \
    ...
    --top-module tb_agr_fft_stage \
    --cc ../rtl/agr_fft_stage.sv \
        ../../agr_fft_butterfly_scaled/rtl/agr_fft_butterfly_scaled.sv \
        ...
        ../tb/tb_agr_fft_stage.sv \
    --exe tb_agr_fft_stage.cpp \
